      ...
      child: Wrap(spacing: 8, runSpacing: 8, crossAxisAlignment: WrapCrossAlignment.center, children: [
        ...
        SizedBox(
          ...
          child: DropdownButtonFormField<String?>(
            ...
            style: TextStyle(color: AppColors.textPrimary, fontSize: 12),
            decoration: InputDecoration(labelText: t.statusFilterLbl, isDense: true),
            items: [
              DropdownMenuItem(value: null, child: Text(t.allStatuses, overflow: TextOverflow.ellipsis)),
              ...statusOpts.map((o) {
                final m = Map<String, dynamic>.from(o);
        ...
        if (allTags.isNotEmpty)
          SizedBox(
            ...
            child: DropdownButtonFormField<String?>(
              ...
              dropdownColor: AppColors.surface,
              style: TextStyle(color: AppColors.textPrimary, fontSize: 12),
            decoration: InputDecoration(labelText: t.tagFilterLbl, isDense: true),
            items: [
              DropdownMenuItem(value: null, child: Text(t.allTags, overflow: TextOverflow.ellipsis)),
        ...
        FilterChip(
          label: Text(t.hasNoteChip, style: const TextStyle(fontSize: 11)),
        ...
        if (filters.search.isNotEmpty || filters.status != null || filters.hasNoteOnly || filters.tag != null)
          TextButton.icon(onPressed: () => ref.read(taskFiltersProvider.notifier).clear(), icon: const Icon(Icons.clear, size: 14), label: Text(t.clearFiltersBtn)),
        const SizedBox(width: 4),
        Text(t.filtersActive(_activeCount(filters)), style: TextStyle(fontSize: 10, color: AppColors.textSecondary)),
      ]),
    );
  }
